...
function Quizpopup() {
  ...
  return (
    ...
    <button className='bg-blue-700 p-2 rounded-lg text-white' onClick={()=>router.push("/quiz")}>Start Quiz</button>
    <button className="bg-blue-700 p-2 rounded-lg ml-6 text-white" onClick={()=>router.push("/quizaskque")}>Post Question</button>
      </section>
      </main>
  )
}
